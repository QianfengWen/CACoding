...
public class SignupUseCaseFactory {
    ...
    public static SignupView create(
        ...
        try {
            ...
            ClearController clearController = createUserClearUseCase(viewManagerModel, signupViewModel, loginViewModel, userDataAccessObject);
    ...
    private static ClearController createUserClearUseCase(ViewManagerModel viewManagerModel, SignupViewModel signupViewModel, LoginViewModel loginViewModel, FileUserDataAccessObject userDataAccessObject) throws IOException {
        ...
        ClearInputBoundary userClearInteractor = new ClearInteractor(
                userDataAccessObject, ClearOutputBoundary, userFactory, userDataAccessObject);
